...
public class MenuSetting {
	...
	public static String appId = "wx864a6334e0d2d890";
    public static String appSecret= "28a5951260ecaf6d6d8ff8690b969d7f"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://p2vwgp.natappfree.cc/Weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
